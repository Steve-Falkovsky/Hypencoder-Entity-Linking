...
from entitytools.crossencoder import train_basecrossencoder
from entitytools.parallelcrossencoder import train_parallelcrossencoder
from entitytools.multicrossencoder import train_multicrossencoder
from entitytools.passagecrossencoder import train_passagecrossencoder
from entitytools.documentcrossencoder import train_documentcrossencoder
...
def main():
    ...
    parser.add_argument('--crosstype', required=True, type=str, help='Type of the crossencoder: base, parallel, multi,'
                                                                     'passage or document')
    ...
    if args.crosstype == 'base':
        func = train_basecrossencoder
    elif args.crosstype == 'parallel':
        func = train_parallelcrossencoder
    elif args.crosstype == 'multi':
        func = train_multicrossencoder
    elif args.crosstype == 'passage':
        func = train_passagecrossencoder
    else:  # if args.crosstype = 'document'
        func = train_documentcrossencoder
    ...
    if args.mode == 'train':
        ...
        process_time = func(
            ...
            ontology,
            candidates_lookup,
            top_k=params[args.crosstype + "crossencoder"]["top_k"],
            learning_rate=params[args.crosstype + "crossencoder"]["learning_rate"],
            batch_size=params[args.crosstype + "crossencoder"]["batch_size"],
            output_dir=args.output_dir,
            crossencoder_model=params[args.crosstype + "crossencoder"]["model_name"],
            crossencoder_size=params[args.crosstype + "crossencoder"]["model_max_length"]
        )
        ...
        tune_with_wandb(
            project='el_' + args.crosstype + 'crossencoder',
            ...
            fixed_args={
                ...
                "batch_size": 2,
                "crossencoder_model": "microsoft/BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext",
                "crossencoder_size": 512
            },
            tunable_args={
                "top_k": [1, 2, 3, 4, 5],
